...
int traverse_file(char* filename) {
	...
	if(category == "social-networking")
	...
	else if(category == "online-storage-and-backup")
	  {
   	...
   	else if(category == "content-delivery-networks")
	  {
	    TbbVec1.push_back(stol(tms));
	    TbbVec2.push_back(stol(bytes));
	    TbbVec3.push_back(s);
	    TbbVec_category.push_back(4);
	  }
	else if(category == "streaming-media")
	  {
	    TbbVec1.push_back(stol(tms));
	    TbbVec2.push_back(stol(bytes));
	    TbbVec3.push_back(s);
	    TbbVec_category.push_back(5);
	  }
	else
	  {
	    TbbVec1.push_back(stol(tms));
...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    filename = "tmp-content-delivery-networks";
    category_counter = 0;

    start_category = TbbVec_category.begin();
    for(start_timestamp = TbbVec1.begin(); start_timestamp != end_timestamp; ++start_timestamp)
      {    
	if((long)*start_category == 4)
	  {
	    category_counter++;
	  }
	start_category++;
    ...
    filename = "tmp-streaming-media";
    category_counter = 0;

    start_category = TbbVec_category.begin();
    for(start_timestamp = TbbVec1.begin(); start_timestamp != end_timestamp; ++start_timestamp)
      {    
	if((long)*start_category == 5)
	  {
	    category_counter++;
	  }
	start_category++;
