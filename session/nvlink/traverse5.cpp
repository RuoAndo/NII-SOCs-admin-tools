...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    long *h_key;
    h_key = (long *)malloc(TbbVec1.size()*sizeof(long));

    long *h_value_count;
    h_value_count = (long *)malloc(TbbVec1.size()*sizeof(long));

    long *h_value_bytes;
    h_value_bytes = (long *)malloc(TbbVec3.size()*sizeof(long));
    ...
    for(start1 = TbbVec1.begin();start1 != end1;++start1)
      {    
	// cout << *start1 << "," << *start_application << endl;

	h_key[counter] = (long)*start1;
