...
typedef tbb::concurrent_vector<int> iTbb_Vec_country;
iTbb_Vec_country TbbVec_country;
...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    tbb::concurrent_vector<int>::iterator start_country;
    tbb::concurrent_vector<int>::iterator end_country = TbbVec_country.end();
