...
int main(int argc, char **argv) {
  ...
  */
  ...
  printf("testing sgemm... with %d size \n", N);
  ...
  for (i = 0; i < n2; i++) {
    ...
    h_C_ref[i] = rand() / static_cast<float>(RAND_MAX);
  }
  ...
  cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, N, N, N, alpha, h_A, N, h_B, N, beta, h_C_ref, N);
