...
scp msec-inward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/inward/gpu03/store/
scp msec-inward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/inward/gpu03/current
scp raw-inward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/inward/gpu03/raw/
...
scp msec-outward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/outward/gpu03/store/
scp msec-outward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/outward/gpu03/current
scp raw-outward-${DATE} 192.168.72.6:/mnt/sdc/splunk-session-directed/outward/gpu03/raw
