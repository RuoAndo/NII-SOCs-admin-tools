...
records_bytes_avg = foreach filtered_records_all generate filtered_records.session_id, filtered_records.bytes, AVG(filtered_records.bytes);
-- dump filtered_records;
