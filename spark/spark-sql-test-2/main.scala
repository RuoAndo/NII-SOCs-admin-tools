...
case class Dessert(timestamp:String, destIP:String, sourceIP:String)
...
object Main {
  def main(args: Array[String]) {
      ...
      val dessertRDD = sc.textFile("hdfs://192.168.76.216:9000/user/hadoop/sinet_egress_all_20201217")
	  ...
	  Dessert(timestamp, destIP, sourceIP)
	  }.toDF
