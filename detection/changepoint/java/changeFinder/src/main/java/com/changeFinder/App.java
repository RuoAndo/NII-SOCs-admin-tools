...
public class App 
{
	...
	try{
	    ...
	    File file = new File("/home/flare/nii-cyber-security-admin/detection/changepoint/java/changeFinder/src/main/java/com/changeFinder/RN2");
