...
int traverse_file(char* filename, char* srchstr, int thread_id) {
	...
	*/	
	...
	std::cout << "threadID" << thread_id_local << ":" << filename << ":" << tms_string.timestamp_string << std::endl;

	/*
	unsigned long long timestamp_ull = stoull(timestamp_string[thread_id_local]);	
