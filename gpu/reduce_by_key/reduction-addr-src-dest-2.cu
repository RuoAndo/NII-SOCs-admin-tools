  ...
  // int counter = 0;
	...
	try {
	  ...
	  */
	  ...
	  // thrust::sort_by_key(dkey_out.begin(), dkey_out.end(), dvalue_out.begin(),thrust::greater<int>());
	  thrust::sort_by_key(dvalue_out.begin(), dvalue_out.end(), dkey_out.begin(),thrust::greater<int>());

	  ofstream outputfile("reduced-2");  
