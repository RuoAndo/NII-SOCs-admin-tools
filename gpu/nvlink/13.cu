...
int main( int argc, char* argv[] ) {
  ...
  tbb::tick_count mainStartTime = tbb::tick_count::now();
	...
	vector<vector<string>> data; 
	  ...
	  cudaSetDevice(0);
	  thrust::device_vector<long> dkey_out_1(N);
	  thrust::device_vector<long> dvalue_out_1(N);
	  ...
	  cudaSetDevice(1);
	  thrust::device_vector<long> dkey_out_2(N);
	  thrust::device_vector<long> dvalue_out_2(N);
	  ...
	  */
	  ...
	  cudaSetDevice(0);
          thrust::host_vector<long> hkey_out_3(N);
	  thrust::host_vector<long> hvalue_out_3(N);
	  ...
	  thrust::sort(dkey_out_3.begin(), dkey_out_3.end());
	  ...
	  for(long i=0; i <new_size_4; i++)
	    {
		outputfile2 << dkey_out_4[i] << "," << dvalue_out_4[i] << endl;
	    }
