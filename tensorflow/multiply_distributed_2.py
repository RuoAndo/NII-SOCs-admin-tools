...
if tf.test.is_built_with_cuda():
    with tf.device('/cpu:0'):
        a = sess.run(tf.random_normal(shape=[1,40000],mean=0.0,stddev=1.0,dtype=tf.float32))
        b = sess.run(tf.random_normal(shape=[40000,1],mean=0.0,stddev=1.0,dtype=tf.float32))
